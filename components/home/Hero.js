...
export default function Hero() {
    ...
    return (
     ...
     <div className=" sm:px-6 lg:h-full md:h-screen h-full lg:px-20 md:px-14 px-6 lg:py-24 md:py-12 py-20  lg:grid lg:grid-flow-col lg:grid-cols-6 md:grid md:grid-flow-col md:grid-cols-2 gap-10 flex flex-col space-y-6">
            ...
            <div className="flex flex-col space-y-20 justify-center items-center lg:w-96 md:w-96 lg:px-0 md:px-0 px-4 w-full">
                <motion.div initial={{ scale:0 , opacity:0, rotate: 100 }} whileInView={{ scale:1 , opacity:100, rotate: 5 }} transition={{ type: "spring", stiffness: 80, damping: 10 }} className="lg:col-span-2 w-full lg:h-96 md:h-96 h-96 bg-gray-900 border border-gray-800  flex justify-center items-center">
