...
export default function Button({isPrimary, text , linkTo}) {
    ...
    <Link href={linkTo} className="w-full md:w-64 lg:w-64">
        <div className="relative w-full md:w-64 lg:w-64">
            <div className={isPrimary? "flex justify-center items-center text-sm w-full md:w-64 lg:w-64 lg:px-20 md:px-12 py-4 bg-yellow-400 ": "flex justify-center items-center text-sm w-full md:w-64 lg:w-64 lg:px-20 md:px-12 py-4 bg-none border-gray-100 border text-white" }>
                {text}
            </div>
